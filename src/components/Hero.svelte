...
<section>
  ...
  >
    <div class="mx-auto max-w-xl text-center">
      ...
      <p class="mt-4 sm:text-lg/relaxed">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        ...
        <a
          class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-red-600 shadow hover:bg-gray-100 hover:text-red-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
          href="/about"
        >
          Learn More
        </a>
