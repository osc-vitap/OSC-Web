...
<section>
	<div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center">
		<div class="max-w-xl">
			<h1 class="text-4xl font-extrabold sm:text-4xlz text-white">
				Lorem Ipsum
				<strong class="font-extrabold text-purple-100 sm:block"> Dolor sit amet. </strong>
			</h1>

			<p class="mt-4 sm:text-md/relaxed max-w-sm text-white">
