      ...
      <div class="mx-auto max-w-screen-xl py-16 lg:flex lg:items-center">
        <div class="max-w-xl">
          ...
          <p class="mt-4 text-xs sm:text-md/relaxed max-w-sm text-white">
            ...
            veniam, quis nostrud exercitation ullamco tu. Tenetur a sapiente
            delectus.
          </p>
      ...
      <div>
        <Card img="/images/image-1.webp" reverse={vCard}>
          ...
          >
            ...
            autem quaerat tempora quos eum delectus perferendis, maiores
            repellat corporis nisi quibusdam veritatis cumque voluptatum nulla
            aspernatur necessitatibus vel voluptas!
          </p>
          <Button>
            Read more <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <Toggle bind:checked={vCard} class="mt-4 italic dark:text-gray-500"
          >Reverse</Toggle
        >
      </div>
    </section>
