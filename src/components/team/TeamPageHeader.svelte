<div class="w-full max-w-screen-xl py-8 px-6 lg:px-8 sm:pt-24">
	<div class="flex items-center justify-between">
		<section>
			<div class="mx-auto max-w-screen-xl py-8 lg:flex lg:items-center">
				<div class="max-w-xl">
					...
					<p class="mt-2 text-md/relaxed max-w-sm text-white">
      ...
      <div>
        ...
        >
          <span
            class="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-cyan-500 via-teal-500 to-blue-500 group-hover:opacity-100"
          />
          <!-- Top glass gradient -->
          <span
          ...
          <span class="relative flex items-center">
            ...
            <span class="ml-2 text-xs sm:text-md">Join our team today!</span>
          </span>
        </a>
      </div>
		</section>
