<script>
	...
	import OscShortLogo from '../images/OSC_Short_Logo.svelte';
	import { onMount } from 'svelte';
	var recruiting_status = false;
	onMount(() => {
...
{#if recruiting_status == true}
	<Banner>
		<OscShortLogo height="28" />

		<a
			class="flex items-center text-sm text-gray-500 dark:text-gray-400 underline font-semibold border-l-2 ml-2 pl-2 border-zinc-300"
			href="/"
		>
